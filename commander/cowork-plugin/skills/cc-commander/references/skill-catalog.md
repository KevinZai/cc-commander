...
Each mega-skill is a router that dispatches to specialist sub-skills automatically.

### mega-design (35+ sub-skills)
UI/UX design, Impeccable polish suite, visual effects, responsive design, accessibility, animation, color theory, typography, layout, component design, design systems, Tailwind patterns, shadcn/ui components, dark mode, motion design, canvas design, SVG animation, generative backgrounds, particle systems, WebGL shaders, interactive visuals, retro pixel art.

### mega-marketing (46 sub-skills)
Content strategy, CRO, growth hacking, email sequences, ad creative, analytics, conversion optimization, landing pages, signup flows, paywall optimization, churn prevention, referral programs, cold email, guest blogging, backlink audits, SEO content briefs, SERP analysis, competitor alternatives, free tool strategy, social integration, video gallery, form CRO, A/B testing, email capture, bulk page generation, content creation.
...
|----------|-------|---------|
| Design | 35+ | frontend-design, motion-design, canvas-design, colorize |
| Marketing | 46 | content-strategy, email-capture, landing-page-builder |
| Development | 40+ | api-design, backend-patterns, python-patterns, laravel |
| Testing | 15 | tdd-workflow, e2e-testing, webapp-testing |
| DevOps | 20 | docker-development, github-actions, aws-patterns |
| SEO | 19 | seo-optimizer, ai-seo, serp-analyzer |
| Security | 9 | pentest-checklist, harden, container-security |
| Research | 8 | mega-research, investigate, brainstorming |
| Productivity | 10+ | session-startup, save-session, context-budget |
| Documentation | 5+ | docs, update-docs, update-codemaps |
