...
There are 350+ skills organized into 11 CCC domains: SEO (19 sub-skills), Design (35+), Testing (15), Marketing (46), SaaS (20), DevOps (20), Research (8), Mobile (7), Security (9), and Data (8). Each CCC domain acts as a router: load one and it dispatches to the right specialist based on your request.
...
350+ skills. 78+ commands. 25 hooks. 11 CCC domains. 9 modes. 36+ prompt templates. 3 starter templates. Real-time dashboard.
...
- **Skills that encode domain expertise.** The 350+ skills capture patterns from 200+ community sources and my own production experience. Each skill is a self-contained instruction set that loads on demand.
...
CC Commander v2.1.0 is the most comprehensive single-install toolkit in this ecosystem: 350+ skills, 78+ commands, 25 hooks, 11 CCC domains, 9 modes, 36+ prompt templates, and a real-time dashboard. All open source. All free.
