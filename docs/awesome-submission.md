...
```markdown
- [CC Commander](https://github.com/KevinZai/cc-commander) - The complete Claude Code configuration toolkit with 350+ skills, 78+ commands, 25 hooks, 9 workflow modes, 10 themes, prompt templates, starter project templates, real-time agent dashboard, and a one-line installer. Includes beginner-friendly PM mode, multi-agent orchestration, and cross-surface state sync.
```
...
**Key features:**
- 350+ skills organized by category (11 CCC domains with router pattern)
