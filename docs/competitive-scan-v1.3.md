...
- **Our coverage:** Partial — we have 350+ skills but no bundle/package system
...
- **Our coverage:** Partial — we have 350+ skills but are Claude Code focused
...
1. **Skills System** — 350+ skills vs closest competitor at 30 commands (SuperClaude). We're the largest skill library that ships as one installable kit.
...
6. **We're still the most comprehensive single-install kit.** No competitor matches our breadth (350+ skills, 78+ commands, 18 kit-native hooks, 9 modes, 10 themes, 36+ templates). Our moat is comprehensiveness + curation quality.
