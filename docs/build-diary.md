...
- Tagline: "350+ skills. One command. Your AI work, managed by AI."
...
- Full references/ content: skill-catalog.md (all 350+ skills categorized), orchestration.md (package detection + phase mapping)
