...
- v1.3
- 350+ skills, 11 CCC domains, 78+ commands, 25 hooks
- Add kevinz.ai URL
- Keep "by Kevin Z"
...
Creator of CC Commander (350+ skills, open source).
...
- **CC Commander** — "350+ skills for Claude Code. Open source." → GitHub link
