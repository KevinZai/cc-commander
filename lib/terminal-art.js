// ============================================================================
// The Claude Code Bible — Terminal Art Library (Node.js)
// ============================================================================
...
function statusBlock({ step, nextStep, done, total, suggestions }) {
  ...
  const lines = [
    `${C.mid}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${C.reset}`,
    `${C.mid}┃${C.reset}  ${C.bright}${C.bold}BIBLE${C.reset}  ${bar}  ${C.dim}tasks done${C.reset}    ${C.mid}┃${C.reset}`,
...
function minimalFooter() {
  return `${C.dim}━━━━━━${C.reset} ${C.mid}CCB${C.reset} ${C.dim}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${C.reset}`;
}
