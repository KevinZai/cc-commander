// ============================================================================
// Kevin Z's Claude Code Kit — Terminal Art Library (Node.js)
// ============================================================================
...
function statusBlock({ step, nextStep, done, total, suggestions }) {
  ...
  const lines = [
    `${C.mid}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${C.reset}`,
    `${C.mid}┃${C.reset}  ${C.bright}${C.bold}KZ KIT${C.reset}  ${bar}  ${C.dim}tasks done${C.reset}    ${C.mid}┃${C.reset}`,
...
function minimalFooter() {
  return `${C.dim}━━━━━━${C.reset} ${C.mid}KZ${C.reset} ${C.dim}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${C.reset}`;
}
